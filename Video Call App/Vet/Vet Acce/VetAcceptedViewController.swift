//
//  VetAcceptedViewController.swift
//  Video Call App
//
...
class VetAcceptedViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    @objc func chatPageButtonClick(sender:UIButton)
    {
        ...
        self.petList = SelectPetOwnerDetails["pet"] as! NSArray
    ...
    @IBAction func listOfPetOwnerButtonClick(_ sender: Any)
    {
        let storyboard = UIStoryboard(name: "Veterinarian", bundle: nil)
        let ListOfPetOwnerViewController = storyboard.instantiateViewController(withIdentifier: "ListOfPetOwnerViewController") as! ListOfPetOwnerViewController
        
        self.navigationController?.pushViewController(ListOfPetOwnerViewController, animated: true)
    }
